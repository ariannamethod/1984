...
"saliva","bile","sweat2","mucus","plasma","hormone","adrenaline","cortisol","dopamine","serotonin",
...
"paranoia","faith","skepticism","devotion2","ambivalence","rapture","languor","fervor","detachment","intimacy",
// TIME 300-349
...
"cycle","season","spring","summer","autumn","winter","dawn2","twilight","midnight2","noon",
// SOCIETY 350-449
...
"power","authority","obedience","rebellion","protest","silence2","censorship","propaganda","truth","lie",
...
// ABSTRACT 450-549
"truth2","meaning","purpose","existence","essence","nothing","everything","something","void","chaos",
"order","pattern","rhythm2","frequency","resonance","harmony","dissonance","entropy","emergence","threshold",
"paradox","contradiction","ambiguity","certainty2","probability","fate","chance","luck","destiny","prophecy",
"dream","nightmare","illusion","reality","fiction","myth","legend","story","narrative","silence3",
"question","answer","riddle","secret","mystery","clue","sign","symbol","code","language",
"thought","idea","concept","theory","belief","knowledge","ignorance","wisdom2","folly","genius",
"beauty","ugliness","sublime","grotesque","sacred","profane","mundane","extraordinary","ordinary","unique",
"infinity","zero","one","half","double","mirror","echo","shadow2","reflection","ghost2",
"gravity","magnetism","electricity","light","darkness","warmth","cold","pressure","vacuum","wave",
"boundary2","threshold2","edge","center","margin","surface","depth","height","distance","proximity",
// ACTION 550-649
"walk","run","stop","breathe","sleep","wake","dream2","remember","forget","imagine",
"create","destroy","build","break2","shape","melt","freeze","burn","grow","shrink",
"open","close","begin","end","continue","wait2","search","find","lose","hide",
"reveal","watch","listen","speak","whisper2","scream2","sing","dance","fight","surrender2",
...
"give","take","receive","share","steal","return2","exchange","sacrifice","hoard","offer",
// MATERIAL 650-749
"iron","copper","gold","silver","glass","clay","wax","ink","paint","paper",
"silk","wool","cotton","leather","stone2","marble","wood2","bamboo","rope","wire",
"blade","needle","hammer","anvil","forge","kiln","loom","wheel","axle","lever",
"mirror2","lens","prism","crystal","gem","pearl","amber","jade","rust","patina",
"grain","fiber","thread","mesh","lattice","grid","weave2","knot","stitch","patch",
...
"machine","engine","gear","spring2","valve","piston","circuit","battery","signal","antenna",
// FOOD 750-799
"bread","salt2","sugar","honey","milk","butter","cheese","meat","fish","egg",
"grain2","rice","wheat","corn","fruit","apple","grape","olive","lemon","pepper",
"wine","water2","tea","coffee","broth","soup","stew","feast2","crumb","morsel",
"harvest","garden","soil","compost","ferment","yeast","dough","crust","marrow2","nectar",
"spice","herb","mint","thyme","sage","garlic","onion","mushroom","berry","kernel",
// ARCHITECTURE 800-849
"house","room","wall2","floor","ceiling","door","window","stair","corridor","basement",
"tower","bridge2","arch","column","dome","vault","foundation","ruin","temple2","altar",
"threshold3","passage","labyrinth","maze","chamber","cell2","shelter","fortress","prison","garden2",
"roof","chimney","hearth","frame","beam","pillar","brick","mortar","tile","glass2",
"balcony","terrace","courtyard","gate2","fence","path","road2","intersection","tunnel","well",
// RELATIONSHIP 850-929
"mother","father","child","daughter","son","sister","brother","family","ancestor","descendant",
"friend","stranger2","lover","enemy2","neighbor2","companion","rival","mentor","student","witness2",
"husband","wife","partner","orphan","widow","elder","infant","twin","cousin","godmother",
"promise","oath","vow","contract","alliance","betrayal2","reconciliation","farewell","reunion","absence",
"kiss","embrace2","handshake","slap","caress","quarrel","conversation","confession","accusation","apology",
"birth","death","marriage","divorce","inheritance","adoption","abandonment","protection","neglect","sacrifice2",
"trust2","suspicion","loyalty","treachery","devotion3","indifference2","jealousy2","admiration2","dependence","autonomy",
"intimacy2","distance2","connection","isolation","belonging","exile2","homecoming","departure","waiting","return3",
// PHILOSOPHY 930-999
"consciousness","awareness","perception","sensation","intuition","reason","logic","paradox2","dialectic","synthesis",
"freedom2","determinism","causation","contingency","necessity","possibility","impossibility","actuality","potential","becoming",
"subject","object","self","other","identity2","difference","sameness","change","permanence","flux",
"being","nothingness","existence2","essence2","phenomena","noumena","appearance","reality2","illusion2","truth3",
"ethics","morality","virtue","vice","good","evil","right2","wrong","duty2","choice",
"justice2","mercy2","punishment2","reward","guilt2","innocence","responsibility","consequence","intention","action",
"language2","meaning2","sign2","reference","representation","interpretation","understanding","misunderstanding","translation","silence4",
// MUSIC 1000-1049
"melody","rhythm3","chord","pitch","tone","note","bass","treble","octave","harmony2",
"dissonance2","resonance2","vibration","frequency2","amplitude","tempo","beat","rest","pause2","crescendo",
"murmur","hum","buzz","click","crack","boom","rumble","chime","echo2","reverb",
...
// WEATHER 1050-1099
"rain2","drizzle","downpour","hail","sleet","blizzard","hurricane","tornado","drought","flood",
"breeze","gale","typhoon","monsoon","frost2","thaw","haze","smog","rainbow2","mirage",
"erosion","sedimentation","crystallization","evaporation","condensation","precipitation","sublimation","oxidation","combustion","decay",
"magma","lava","quartz","granite","obsidian2","chalk","slate","sandstone","limestone","basalt",
"marsh","delta","gorge","ridge","summit","abyss","chasm","rift","fault","crater",
// RITUAL 1100-1149
"prayer","meditation","ritual","ceremony","blessing","curse","oath2","vow2","pilgrimage","procession",
"offering","sacrifice3","communion","baptism","funeral","wedding","coronation","initiation","exile3","absolution",
"incense","candle2","bell2","chant","mantra","psalm","scripture","prophecy2","oracle","vision",
"mask","costume","dance2","feast3","fast","vigil","silence5","confession2","penance","redemption",
"altar2","shrine","temple3","tomb","relic","artifact","amulet","talisman","totem","icon",
// LABOR 1150-1199
"harvest2","planting","sowing","reaping","threshing","milling","baking","brewing","weaving","spinning",
...
"workshop","studio","laboratory","field","dock","quarry","furnace","mill","press","loom2",
// GEOMETRY 1200-1249
"circle","spiral","line","curve","angle","edge2","center2","margin2","border2","frame2",
"sphere","cube","pyramid","cylinder","cone","helix","vortex","arc","wave2","fractal",
"symmetry","asymmetry","proportion","ratio","scale2","dimension","plane","axis","vertex","intersection2",
"pattern2","grid2","lattice2","mesh2","tessellation","rotation","reflection2","translation2","dilation","projection",
"surface2","volume","area","perimeter","diameter","radius","tangent","normal","parallel","perpendicular",
// ANIMAL 1250-1299
"horse","dog","cat","bird","fish2","snake2","bear","fox","rabbit","turtle",
...
// COLOR 1300-1349
"red","blue","green","white","black","gray","amber2","violet","indigo","scarlet",
"crimson","azure","emerald","ivory","obsidian3","silver2","golden","copper2","rust2","ochre",
"bright","dark","transparent","opaque","matte","glossy","rough","smooth","coarse","fine",
"stripe","dot","plaid","solid","gradient","shadow3","highlight","contrast","saturation","hue",
"velvet","satin","linen","denim","lace","gauze","burlap","chiffon","tweed","corduroy",
// TRANSPORT 1350-1399
"ship","boat","canoe","raft","anchor","sail","rudder","oar","mast","hull",
"train","rail","station","platform","ticket","journey","passage2","crossing","departure2","arrival",
"wheel2","axle2","road3","highway","path2","trail","bridge3","tunnel2","gate3","crossroad",
"wing","flight","altitude","turbulence","landing","orbit","trajectory","velocity","acceleration","gravity2",
"horse2","carriage","wagon","cart","sled","bicycle","motorcycle","automobile","truck","ambulance",
// DOMESTIC 1400-1449
"kitchen","bedroom","bathroom","attic","cellar","closet","drawer","shelf","table","chair",
"bed","pillow","blanket","curtain","carpet","lamp","mirror3","photograph2","vase","clock2",
"plate","spoon","knife","fork","cup2","pot","pan","kettle","oven","stove",
"soap","towel","broom","bucket","needle2","thread2","button","zipper","hanger","basket",
"door2","window2","lock2","key2","handle","hinge","nail","screw","bolt","hook",
// COMMUNICATION 1450-1499
"letter2","envelope","stamp","address","message","telegram","telephone","radio","broadcast","signal2",
"newspaper","headline","article","column2","editorial","report","announcement","rumor","gossip","testimony",
"ink2","pen","pencil","typewriter","keyboard","screen","printer","paper2","notebook","diary",
"conversation2","dialogue","monologue","debate","argument","negotiation","compromise","ultimatum","declaration","speech",
"translation3","interpretation2","code2","cipher","encryption","decryption","password","signature","seal","authentication",
// MEDICAL 1500-1549
...
"hospital2","clinic","pharmacy","laboratory2","ambulance2","stretcher","scalpel","syringe","stethoscope","thermometer2",
"fever2","cough","rash","swelling","numbness","dizziness","insomnia","fatigue2","nausea2","tremor2",
"pulse2","pressure2","temperature","respiration","circulation","digestion","metabolism","reflex2","coordination","balance",
// COSMIC 1550-1599
"universe","galaxy","constellation","planet","asteroid","meteorite","satellite","orbit2","void2","singularity",
"photon","electron","proton","neutron","atom","molecule","particle","quantum","field2","dimension2",
"spacetime","relativity","entropy2","thermodynamics","radiation","spectrum","wavelength","frequency3","amplitude2","interference",
"supernova","blackhole","pulsar","quasar","nebula2","wormhole","antimatter","darkmatter","redshift","expansion",
"telescope2","observatory","mission","launch","countdown","trajectory2","reentry","landing2","exploration","discovery2",
...
"office","desk","file","folder","stamp2","signature2","receipt","invoice","ledger","archive",
"committee","department","ministry","bureau","agency","institution","organization","corporation","foundation2","commission",
"report2","audit","review","inspection","evaluation","assessment","benchmark","statistic","data","record",
// MYTHIC 1650-1699
"oracle2","prophecy3","fate2","destiny2","curse2","blessing2","quest","trial","sacrifice4","redemption2",
"labyrinth2","threshold4","guardian","shadow4","mirror4","mask2","transformation","metamorphosis","resurrection","apocalypse",
"phoenix","dragon","serpent","sphinx","minotaur","chimera","hydra","golem","specter","wraith",
"underworld","paradise","purgatory","limbo","abyss2","eden","babylon","atlantis","olympus","tartarus",
"hero2","villain","trickster","sage2","fool","maiden","crone","warrior","healer2","shapeshifter",
// TEXTUAL 1700-1749
"word2","sentence2","paragraph2","chapter2","verse2","stanza","line2","margin3","footnote","epilogue",
...
"manuscript","draft","revision","erasure","correction","annotation","citation","reference2","index","bibliography",
// PSYCHOLOGICAL 1750-1799
"unconscious","subconscious","conscious","ego","superego","libido","repression","projection","sublimation2","transference",
"trauma","complex","fixation","regression","denial2","rationalization","displacement","compensation","identification","dissociation",
"archetype","persona","anima","animus","shadow5","self2","individuation","integration","fragmentation","wholeness",
"attachment","separation","abandonment2","dependency","autonomy2","codependency","boundary3","enmeshment","differentiation","fusion",
"grief2","mourning","acceptance2","bargaining","anger","depression2","recovery2","relapse2","healing","scarring",
// FINAL 1800-1983
"threshold5","crossroad2","watershed","turning","pivot","fulcrum","catalyst","trigger","spark2","fuse",
"tension","release2","compression","expansion2","contraction","oscillation","vibration2","pulsation","undulation","fluctuation",
"accumulation","erosion2","saturation2","depletion","renewal","regeneration","decomposition","fermentation","crystallization2","dissolution",
"echo3","reverberation","aftershock","aftermath","residue","remnant","trace","vestige","fossil","ruin2",
"dawn3","twilight2","liminal","transitional","ephemeral","permanent","transient","enduring","fleeting","eternal",
"anchor2","drift2","mooring","compass2","lighthouse","beacon","signal3","warning","invitation","summons",
"whisper3","murmur2","declaration2","proclamation","confession3","accusation2","plea","verdict","sentence3","pardon",
"seed2","sprout","bud","blossom","fruit2","harvest3","decay2","compost2","soil2","rebirth",
"wound2","suture","bandage2","scar2","healing2","infection2","immunity2","antibody","fever3","remission",
"stranger3","acquaintance","confidant","accomplice","bystander","mediator","advocate","adversary","guardian2","orphan2",
"question2","hypothesis","experiment2","observation","conclusion","revision2","doubt2","certainty3","approximation","precision",
"fragment","mosaic","collage","assemblage","montage","palimpsest","tapestry","constellation2","archipelago","network",
"migration","exodus","diaspora","pilgrimage2","wandering","settlement","foundation3","demolition2","reconstruction","adaptation",
"inheritance2","legacy","tradition","innovation","rupture","continuity","evolution","revolution2","stagnation","metamorphosis2",
"silence6","static2","noise","signal4","frequency4","wavelength2","amplitude3","resonance3","interference2","harmony3",
"margin4","periphery","frontier","borderland","hinterland","interior","core","nucleus","membrane","skin2",
"permission","prohibition","transgression","taboo","norm","deviation","exception","precedent","custom","habit",
"witness3","testimony2","evidence","proof","alibi","verdict2","appeal2","clemency","execution","reprieve",
"debt2","credit","interest","principal","collateral","default","bankruptcy","solvency","dividend","investment",
];
